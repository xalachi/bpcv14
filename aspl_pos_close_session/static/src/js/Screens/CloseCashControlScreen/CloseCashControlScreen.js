odoo.define('aspl_pos_close_session.CloseCashControlScreen', function (require) {
    'use strict';
    ...
    class CloseCashControlScreen extends IndependentToOrderScreen {
        ...
        createPrefillCash() {
            ...
            for (var i=0; i<coin_data.length; i++){
                ...
                this.state.closeInputLines.push(nextLine);
            }
        }

        createNewCloseInputLine() {
            this.state.closeInputLines.push(this._nextId(true));
            this.state.showCloseStaticLines = false;
        }
